...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, RLReport, uDmFichaTecnica, rsDBUtils;

type
  TfProdutoCartoR = class(TForm)
    RLReport1: TRLReport;
...
var
  fProdutoCartoR: TfProdutoCartoR;

implementation

{$R *.dfm}

procedure TfProdutoCartoR.RLBand2BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fDmFichaTecnica.cdsProdutoCartoFD_TIPO_MAT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFD_TIPO_MAT.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoTP_TIPO_MAT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoTP_TIPO_MAT.AsInteger of
      1: RLLabel9.Caption := 'DUPLEX';
      2: RLLabel9.Caption := 'MICRO';
      3: RLLabel9.Caption := 'CARTÃO / CARTÃO';
      4: RLLabel9.Caption := 'MICRO / ABAS INTERNAS';
    end;
  if not fDmFichaTecnica.cdsProdutoCartoSP_TIPO_MAT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoSP_TIPO_MAT.AsInteger of
...
procedure TfProdutoCartoR.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fDmFichaTecnica.cdsProdutoCartoFDPINCA.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDPINCA.AsString = 'S' then
      RlDraw5.Brush.Color := clBlack
  end
  else
    RlDraw5.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoFDTRAVA.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDTRAVA.AsString = 'S' then
      RlDraw6.Brush.Color := clBlack
  end
  else
    RlDraw6.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoFDDISPLAY.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDDISPLAY.AsString = 'S' then
      RlDraw7.Brush.Color := clBlack
  end
  else
    RlDraw7.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT_ATRITO.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT_ATRITO.AsString = 'S' then
      RlDraw1.Brush.Color := clBlack
  end
  else
    RlDraw1.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS_ATRITO.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS_ATRITO.AsString = 'S' then
      RlDraw2.Brush.Color := clBlack
  end
  else
    RlDraw2.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT_LUZ.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT_LUZ.AsString = 'S' then
      RlDraw4.Brush.Color := clBlack
  end
  else
    RlDraw4.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS_LUZ.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS_LUZ.AsString = 'S' then
  ...
  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoFDFECHAMENTO.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFDFECHAMENTO.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoFDFECHAMENTO_CT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFDFECHAMENTO_CT.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT_BRIL.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFDREVEST_FT_BRIL.AsInteger of
      1: RLLabel35.Caption := 'BRILHO';
      2: RLLabel35.Caption := 'FOSCO';
      3: RLLabel35.Caption := 'ALTO BRILHO';
    end;
  if not fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS_BRIL.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoFDREVEST_VS_BRIL.AsInteger of
      1: RLLabel36.Caption := 'BRILHO';
      2: RLLabel36.Caption := 'FOSCO';
      3: RLLabel36.Caption := 'ALTO BRILHO';
    end;

  if fDmFichaTecnica.cdsProdutoCartoFDAR.AsString = 'S' then
  begin
    RLLabel51.Visible   := True;
    RLDraw8.Brush.Color := clBlack;
    if not fDmFichaTecnica.cdsProdutoCartoFDAR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDAR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDBR.AsString = 'S' then
  begin
    RLLabel52.Visible   := True;
    RLDraw9.Brush.Color := clBlack;
    if not fDmFichaTecnica.cdsProdutoCartoFDBR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDBR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDHS.AsString = 'S' then
  begin
    RLDraw10.Brush.Color := clBlack;
    RLLabel54.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDHS_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDHS_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDVISOR.AsString = 'S' then
  begin
    RLDraw11.Brush.Color := clBlack;
    RLLabel53.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDVISOR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDVISOR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDVERNIZUV.AsString = 'S' then
  begin
    RLDraw12.Brush.Color := clBlack;
    RLLabel56.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDVERNIZUV_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDVERNIZUV_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDPICOTE.AsString = 'S' then
  begin
    RLDraw13.Brush.Color := clBlack;
    RLLabel62.Visible    := True;
    RLLabel66.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDPICOTE_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDPICOTE_LOCAL.AsInteger of
    ...
    if not fDmFichaTecnica.cdsProdutoCartoFDPICOTE_TIPO.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDPICOTE_TIPO.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDPASSAFITA.AsString = 'S' then
  begin
    RLDraw14.Brush.Color := clBlack;
    RLLabel63.Visible    := True;
    RLLabel67.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDPASSAFITA_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDPASSAFITA_LOCAL.AsInteger of
    ...
    if not fDmFichaTecnica.cdsProdutoCartoFDPASSAFITA_TIPO.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDPASSAFITA_TIPO.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDALCA.AsString = 'S' then
  begin
    RLDraw15.Brush.Color := clBlack;
    RLLabel65.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDALCA_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDALCA_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDILHOS.AsString = 'S' then
  begin
    RLDraw16.Brush.Color := clBlack;
    RLLabel64.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoFDILHOS_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoFDILHOS_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoFDVERNIZUV_TOTAL.AsString = 'S' then
    RLDraw17.Brush.Color := clBlack
  else
    RLDraw17.Brush.Color := clWhite;
end;

procedure TfProdutoCartoR.RLBand4BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fDmFichaTecnica.cdsProdutoCartoTPPINCA.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoTPPINCA.AsString = 'S' then
      RlDraw22.Brush.Color := clBlack
  end
  else
    RlDraw22.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT_ATRITO.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT_ATRITO.AsString = 'S' then
      RlDraw18.Brush.Color := clBlack
  end
  else
    RlDraw18.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS_ATRITO.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS_ATRITO.AsString = 'S' then
      RlDraw19.Brush.Color := clBlack
  end
  else
    RlDraw19.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT_LUZ.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT_LUZ.AsString = 'S' then
      RlDraw21.Brush.Color := clBlack
  end
  else
    RlDraw21.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS_LUZ.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS_LUZ.AsString = 'S' then
      RlDraw20.Brush.Color := clBlack
  end
  else
    RlDraw20.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoTPFECHAMENTO.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoTPFECHAMENTO.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT_BRIL.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoTPREVEST_FT_BRIL.AsInteger of
    ...
    RLLabel84.Caption := '';
  if not fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS_BRIL.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoTPREVEST_VS_BRIL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPAR.AsString = 'S' then
  begin
    RLLabel100.Visible   := True;
    RLDraw25.Brush.Color := clBlack;
    if not fDmFichaTecnica.cdsProdutoCartoTPAR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPAR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPBR.AsString = 'S' then
  begin
    RLLabel101.Visible   := True;
    RLDraw26.Brush.Color := clBlack;
    if not fDmFichaTecnica.cdsProdutoCartoTPBR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPBR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPHS.AsString = 'S' then
  begin
    RLDraw27.Brush.Color := clBlack;
    RLLabel103.Visible   := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPHS_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPHS_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPVISOR.AsString = 'S' then
  begin
    RLDraw28.Brush.Color := clBlack;
    RLLabel102.Visible   := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPVISOR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPVISOR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPVERNIZUV.AsString = 'S' then
  begin
    RLDraw29.Brush.Color := clBlack;
    RLLabel104.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPVERNIZUV_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPVERNIZUV_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPPICOTE.AsString = 'S' then
  begin
    RLDraw30.Brush.Color := clBlack;
    RLLabel111.Visible    := True;
    RLLabel115.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPPICOTE_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPPICOTE_LOCAL.AsInteger of
    ...
    if not fDmFichaTecnica.cdsProdutoCartoTPPICOTE_TIPO.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPPICOTE_TIPO.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPPASSAFITA.AsString = 'S' then
  begin
    RLDraw31.Brush.Color := clBlack;
    RLLabel112.Visible    := True;
    RLLabel116.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPPASSAFITA_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPPASSAFITA_LOCAL.AsInteger of
    ...
    if not fDmFichaTecnica.cdsProdutoCartoTPPASSAFITA_TIPO.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPPASSAFITA_TIPO.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPALCA.AsString = 'S' then
  begin
    RLDraw32.Brush.Color := clBlack;
    RLLabel114.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPALCA_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPALCA_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPILHOS.AsString = 'S' then
  begin
    RLDraw33.Brush.Color := clBlack;
    RLLabel113.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoTPILHOS_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoTPILHOS_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoTPVERNIZUV_TOTAL.AsString = 'S' then
    RLDraw34.Brush.Color := clBlack
  else
    RLDraw34.Brush.Color := clWhite;
end;

procedure TfProdutoCartoR.RLBand5BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  if not fDmFichaTecnica.cdsProdutoCartoSPPINCA.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoSPPINCA.AsString = 'S' then
      RlDraw39.Brush.Color := clBlack
  end
  else
    RlDraw39.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT_ATRITO.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT_ATRITO.AsString = 'S' then
      RlDraw35.Brush.Color := clBlack
  end
  else
    RlDraw35.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS_ATRITO.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS_ATRITO.AsString = 'S' then
      RlDraw36.Brush.Color := clBlack
  end
  else
    RlDraw36.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT_LUZ.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT_LUZ.AsString = 'S' then
      RlDraw38.Brush.Color := clBlack
  end
  else
    RlDraw38.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS_LUZ.IsNull then
  begin
    if fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS_LUZ.AsString = 'S' then
      RlDraw37.Brush.Color := clBlack
  end
  else
    RlDraw37.Brush.Color := clWhite;

  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoSPFECHAMENTO.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoSPFECHAMENTO.AsInteger of
  ...
  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT_BRIL.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoSPREVEST_FT_BRIL.AsInteger of
    ...
    RLLabel138.Caption := '';
  if not fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS_BRIL.IsNull then
    case fDmFichaTecnica.cdsProdutoCartoSPREVEST_VS_BRIL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPAR.AsString = 'S' then
  begin
    RLLabel154.Visible   := True;
    RLDraw42.Brush.Color := clBlack;
    if not fDmFichaTecnica.cdsProdutoCartoSPAR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPAR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPBR.AsString = 'S' then
  begin
    RLLabel155.Visible   := True;
    RLDraw43.Brush.Color := clBlack;
    if not fDmFichaTecnica.cdsProdutoCartoSPBR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPBR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPHS.AsString = 'S' then
  begin
    RLDraw44.Brush.Color := clBlack;
    RLLabel157.Visible   := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPHS_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPHS_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPVISOR.AsString = 'S' then
  begin
    RLDraw45.Brush.Color := clBlack;
    RLLabel156.Visible   := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPVISOR_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPVISOR_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPVERNIZUV.AsString = 'S' then
  begin
    RLDraw46.Brush.Color := clBlack;
    RLLabel158.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPVERNIZUV_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPVERNIZUV_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPPICOTE.AsString = 'S' then
  begin
    RLDraw47.Brush.Color := clBlack;
    RLLabel165.Visible    := True;
    RLLabel169.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPPICOTE_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPPICOTE_LOCAL.AsInteger of
    ...
    if not fDmFichaTecnica.cdsProdutoCartoSPPICOTE_TIPO.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPPICOTE_TIPO.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPPASSAFITA.AsString = 'S' then
  begin
    RLDraw48.Brush.Color := clBlack;
    RLLabel166.Visible    := True;
    RLLabel170.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPPASSAFITA_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPPASSAFITA_LOCAL.AsInteger of
    ...
    if not fDmFichaTecnica.cdsProdutoCartoSPPASSAFITA_TIPO.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPPASSAFITA_TIPO.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPALCA.AsString = 'S' then
  begin
    RLDraw49.Brush.Color := clBlack;
    RLLabel168.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPALCA_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPALCA_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPILHOS.AsString = 'S' then
  begin
    RLDraw50.Brush.Color := clBlack;
    RLLabel167.Visible    := True;
    if not fDmFichaTecnica.cdsProdutoCartoSPILHOS_LOCAL.IsNull then
      case fDmFichaTecnica.cdsProdutoCartoSPILHOS_LOCAL.AsInteger of
  ...
  if fDmFichaTecnica.cdsProdutoCartoSPVERNIZUV_TOTAL.AsString = 'S' then
    RLDraw51.Brush.Color := clBlack
  else
    RLDraw51.Brush.Color := clWhite;
end;

procedure TfProdutoCartoR.FormCreate(Sender: TObject);
begin
